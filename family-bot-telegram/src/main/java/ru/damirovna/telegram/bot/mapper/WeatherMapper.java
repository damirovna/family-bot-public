...
public class WeatherMapper {
    ...
    public static Weather mapToWeather(WeatherMessage weatherMessage) throws ParseException {
        return new Weather(weatherMessage.getTemp(), weatherMessage.getFeelsLike(), weatherMessage.getTempMin(), weatherMessage.getTempMax(), weatherMessage.getWindSpeed(), weatherMessage.getDescription(), DATE_FORMATTER_GET_DAY.parse(weatherMessage.getDate()), weatherMessage.getLocationName());
    }
